...
import com.xinran.dkelianxi.R;
import com.xinran.dkelianxi.utils.DisplayUtil;
...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerHolder startAnimationWithAnination(int viewId, Animation animation){
        ImageView tv = getView(viewId);
    ...
    public BaseRecyclerHolder setClickListner(int viewId, View.OnClickListener listener) {
        getView(viewId).setOnClickListener(listener);
        return this;
    }
    public BaseRecyclerHolder setItemClickListner(View.OnClickListener listener) {
        itemView.setOnClickListener(listener);
        return this;
    }
    public BaseRecyclerHolder setLongClickListner(int viewId, View.OnLongClickListener longClickListener) {
        getView(viewId).setOnLongClickListener(longClickListener);
        return this;
    }
    public BaseRecyclerHolder setItemLongClickListner(View.OnLongClickListener longClickListener) {
